...
echo "  pass insert $PASS_PREFIX/cloudflare/terraform_api_token"
echo "  pass insert $PASS_PREFIX/cloudflare/account_id"
echo "  pass insert $PASS_PREFIX/cloudflare/zone_id"
echo "  pass insert $PASS_PREFIX/cloudflare/tunnel_id"
